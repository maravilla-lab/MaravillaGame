...
class MaravillaGame(QWidget):
    ...
    def conectar_servidor(self):
        try: self.sio.connect("https://github.com/maravilla-lab/MaravillaGame.git")
        except: pass
    def conectar_datos(self):
        try:
            r = requests.post("https://github.com/maravilla-lab/MaravillaGame.git", json={"id": self.uid}, timeout=2).json()
