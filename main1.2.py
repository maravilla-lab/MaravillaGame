...
class MaravillaGame(QWidget):
    ...
    def conectar_servidor(self):
        try: self.sio.connect("https://stunning-compassion-production-443a.up.railway.app")
        except: pass
    def conectar_datos(self):
        try:
            r = requests.post("https://stunning-compassion-production-443a.up.railway.app", json={"id": self.uid}, timeout=2).json()
